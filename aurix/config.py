...
DECISION_PROMPT = (
    ...
    "  PLAY: <song, artist or playlist>  - start music playing\n"
    "  CONTROL: <pause|resume|next|back> - control music already playing\n"
    ...
    "PLAY, CONTROL and OPEN are for being told to do something. Use them "
    "whenever the request is an instruction rather than a question. A question "
    "about music or a website is still SEARCH or DIRECT.\n"
